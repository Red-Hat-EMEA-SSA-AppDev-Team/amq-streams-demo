...
WARNING: *Version 3.2* introduced many breaking changes! All the Kafka CRDs in this repository have been automatically migrated to the latest version of the APIs. A complete review of the content is in progress. The latest stable version of this workshop is available in *v3.0* branch.
...
- Upgraded to _Streams for Apache Kafka version 3.2_
